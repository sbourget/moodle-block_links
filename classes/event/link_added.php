...
/**
 * The block_links link added event.
 *
 * @package    block_links
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class link_added extends \core\event\base {
    /**
     * Init method
     */
    ...
    public static function get_name() {
        return get_string('eventlinkadded', 'block_links');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the a new link with id '$this->objectid'"
                . " for the links block";
    }
